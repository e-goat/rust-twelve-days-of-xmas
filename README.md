...
This is done as part of my recreational programming late-night sessions.
<br> <br>
__Exigent__: Language model (so called AI) have been used in this repo for learning purposes.<br>This repo represents the twelve verses from the Scotish version of the song "The Yule Days"
## Build
...
_Ref: [Wiki]([https://en.wikipedia.org/wiki/Fibonacci_sequence#Closed-form_expression](https://en.wikipedia.org/wiki/The_Twelve_Days_of_Christmas_(song)#Scotland))_
